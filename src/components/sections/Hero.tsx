      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl sm:text-2xl lg:text-3xl font-semibold text-slate-700">
              {personalInfo.title} @ {personalInfo.company}
            </p>

            <div className="flex flex-wrap items-center justify-center gap-3 text-lg sm:text-xl text-slate-600">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-4xl mx-auto pt-8">
            {[
              ...
              <div
                key={stat.label}
                className="p-6 rounded-xl bg-white shadow-md hover:shadow-lg transition-all duration-300 border-2 border-slate-100 hover:border-blue-200 group"
              >
          ...
          <div className="flex items-center justify-center gap-4 pt-8">
            <a
              ...
              className="p-3 rounded-lg bg-white shadow-md hover:shadow-lg hover:scale-110 transition-all duration-300 border-2 border-slate-100 hover:border-blue-300"
              aria-label="GitHub"
            >
