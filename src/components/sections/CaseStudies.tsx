      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4">
            Problems, <span className="text-blue-600">patterns</span> & delivery
          </h2>
        ...
        <div className="text-center">
          <Link
            href="/case-studies/"
            className="inline-flex items-center justify-center gap-2 h-13 px-8 py-3 text-lg font-medium rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors cursor-pointer"
          >
