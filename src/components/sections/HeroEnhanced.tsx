...
import { Github, Linkedin, Mail, Download, ExternalLink, Sparkles, BookOpen, GraduationCap } from 'lucide-react';
import { 
  fadeInUp, 
  fadeInDown, 
  staggerContainer, 
          ...
          >
            <motion.div variants={staggerItem} className="relative z-20">
              <Button
                ...
                variant="primary"
                onClick={() => {
                  trackClarityEvent(CLARITY_EVENTS.VIEW_PROJECTS);
            ...
            <motion.div variants={staggerItem} className="relative z-20">
              <Button
                ...
                variant="ghost"
                onClick={() => {
                  trackClarityEvent(CLARITY_EVENTS.RESUME_DOWNLOAD);
