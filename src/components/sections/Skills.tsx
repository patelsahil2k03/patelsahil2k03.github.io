      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-4xl sm:text-5xl font-bold text-slate-900 mb-4">
            Tech <span className="text-signal-blue">Stack</span>
          </h2>
                ...
                <CardHeader>
                  <CardTitle className="flex items-center gap-3">
                    <div className="p-2 bg-signal-blue/10 rounded-lg group-hover:bg-signal-blue/20 transition-colors">
                      <div className="w-6 h-6 text-signal-blue font-bold flex items-center justify-center">
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-4 text-sm">
          ...
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 bg-status-teal-icon rounded-full" />
            <span className="text-slate-600">Intermediate (70-79%)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 bg-alert-amber-icon rounded-full" />
