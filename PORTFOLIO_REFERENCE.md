...
- [x] Hero: Typing animation, counter, impact statement
- [x] Navigation: Glassmorphism, active highlighting, Publications link, case study routes
- [x] Cards: Hover effects (Card component)
- [ ] Skills: Display all 50+ technologies
- [x] Projects: Metrics + case study links from `relatedProjectId`
- [ ] About: "Beyond Tech" section (football)
...
- [x] Test all sections (manual + production build)
- [x] Fix bugs and issues (Phase 2 + case studies batch)
- [ ] Performance optimization (Lighthouse post-deploy)
- [ ] Accessibility audit
...
### Phase 6: Deployment & Polish 🔄 PARTIAL
- [x] Build for production (`npm run build`, static export)
- [x] Deploy to GitHub Pages (auto on `main`; `dev`/`main` branching 2026-05-29)
- [x] Test live site (case studies routes verified)
- [x] SEO optimization (`layout.tsx` + `seo.ts`)
- [x] Analytics setup (Microsoft Clarity + case-study-view events)
- [ ] Final documentation sync (active docs in `docs/` — keep aligned with releases)
